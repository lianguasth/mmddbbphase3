...
#-----------------------------------------------------------------------------#
def gm_node_degrees (shouldDrop = False):
    cur = db_conn.cursor()
    ...
    gm_sql_table_drop_create(db_conn, GM_NODE_DEGREES, "node_id integer, \
                             in_degree integer, out_degree integer", drop = shouldDrop)
